    ...
    // 3) Query จากฐาน HOSxP (connection 'hosxp')
        ...
        $sqlOpd = '
            SELECT 
                ...
                SUM(a.income) AS inc_total, SUM(a.inc03) AS inc_lab_total, SUM(a.inc12) AS inc_drug_total,
                ...
                SUM(COALESCE(inc.inc_ppfs, 0)) AS inc_ppfs, SUM(COALESCE(inc.inc_ppfs_claim, 0)) AS inc_ppfs_claim, SUM(COALESCE(inc.inc_ppfs_receive, 0)) AS inc_ppfs_receive,
