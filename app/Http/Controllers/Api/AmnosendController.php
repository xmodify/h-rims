        ...
        $sqlOpd = '
            ...
            LEFT JOIN (
                SELECT o.vn,
                    ...
                    LEAST(COALESCE(stm.receive_pp, 0), SUM(CASE WHEN li.ppfs = "Y" THEN o.sum_price ELSE 0 END)) as inc_ppfs_receive,
                    ...
                    LEAST(COALESCE(stm.receive_dmis_drug, 0) + COALESCE(stm.receive_hc_drug, 0) + COALESCE(stm.receive_inst, 0), SUM(CASE WHEN li.uc_cr = "Y" THEN o.sum_price ELSE 0 END)) as inc_uccr_receive,
