...
class CheckDrugcatController extends Controller
{
    ...
    public function drugcat_chi()
    {
        ...
        $drug =  DB::connection('hosxp')->select("
            ...
            WHERE d.istatus = 'Y' AND d.`name` NOT LIKE '*%' AND d.`name` NOT LIKE '(ยาผู้ป่วย)%' AND d.`name` NOT LIKE 'ยาเดิมผู้ป่วย%' AND d.`name` NOT LIKE 'ยาเดิม%'
            ORDER BY d.NAME,d.strength,d.units");
    ...
    public function drugcat_chi_non_nhso()
    {
        ...
        $drug =  DB::connection('hosxp')->select("
            ...
            LEFT JOIN (SELECT dc.* FROM {$local_db}.drugcat_chi dc WHERE  dc.date_approved = (SELECT MAX(dc1.date_approved) 
                FROM {$local_db}.drugcat_chi dc1 WHERE dc.hospdrugcode=dc1.hospdrugcode AND dc1.updateflag IN ('A','U','E'))) nd ON nd.hospdrugcode=d.icode             
            WHERE d.istatus = 'Y' AND d.`name` NOT LIKE '*%' AND d.`name` NOT LIKE '(ยาผู้ป่วย)%' AND d.`name` NOT LIKE 'ยาเดิมผู้ป่วย%' AND d.`name` NOT LIKE 'ยาเดิม%' AND nd.hospdrugcode IS NULL  
            ORDER BY d.NAME,d.strength,d.units");
    ...
    public function drugcat_chi_price_notmatch_hosxp()
    {
        ...
        $drug =  DB::connection('hosxp')->select("
            ...
            LEFT JOIN (SELECT dc.* FROM {$local_db}.drugcat_chi dc WHERE  dc.date_approved = (SELECT MAX(dc1.date_approved) 
                FROM {$local_db}.drugcat_chi dc1 WHERE dc.hospdrugcode=dc1.hospdrugcode AND dc1.updateflag IN ('A','U','E'))) nd ON nd.hospdrugcode=d.icode             
            WHERE d.istatus = 'Y' AND d.`name` NOT LIKE '*%' AND d.`name` NOT LIKE '(ยาผู้ป่วย)%' AND d.`name` NOT LIKE 'ยาเดิมผู้ป่วย%' AND d.`name` NOT LIKE 'ยาเดิม%' AND nd.unitprice <> d.unitprice
            ORDER BY d.NAME,d.strength,d.units");
    ...
    public function drugcat_chi_tmt_notmatch_hosxp()
    {
        ...
        $drug =  DB::connection('hosxp')->select("
            ...
            LEFT JOIN (SELECT dc.* FROM {$local_db}.drugcat_chi dc WHERE  dc.date_approved = (SELECT MAX(dc1.date_approved) 
                FROM {$local_db}.drugcat_chi dc1 WHERE dc.hospdrugcode=dc1.hospdrugcode AND dc1.updateflag IN ('A','U','E'))) nd ON nd.hospdrugcode=d.icode 
            WHERE d.istatus = 'Y' AND d.`name` NOT LIKE '*%' AND d.`name` NOT LIKE '(ยาผู้ป่วย)%' AND d.`name` NOT LIKE 'ยาเดิมผู้ป่วย%' AND d.`name` NOT LIKE 'ยาเดิม%' AND nd.tmtid <> d3.ref_code
            ORDER BY d.NAME,d.strength,d.units");
    ...
    public function drugcat_chi_code24_notmatch_hosxp()
    {
        ...
        $drug =  DB::connection('hosxp')->select("
            ...
            LEFT JOIN (SELECT dc.* FROM {$local_db}.drugcat_chi dc WHERE  dc.date_approved = (SELECT MAX(dc1.date_approved) 
                FROM {$local_db}.drugcat_chi dc1 WHERE dc.hospdrugcode=dc1.hospdrugcode AND dc1.updateflag IN ('A','U','E'))) nd ON nd.hospdrugcode=d.icode 
            WHERE d.istatus = 'Y' AND d.`name` NOT LIKE '*%' AND d.`name` NOT LIKE '(ยาผู้ป่วย)%' AND d.`name` NOT LIKE 'ยาเดิมผู้ป่วย%' AND d.`name` NOT LIKE 'ยาเดิม%' AND nd.ndc24 <> d2.ref_code
            ORDER BY d.NAME,d.strength,d.units");
    ...
    public function drugcat_chi_herb()
    {
        ...
        $drug =  DB::connection('hosxp')->select("
            ...
            LEFT JOIN (SELECT dc.* FROM {$local_db}.drugcat_chi dc WHERE  dc.date_approved = (SELECT MAX(dc1.date_approved) 
                FROM {$local_db}.drugcat_chi dc1 WHERE dc.hospdrugcode=dc1.hospdrugcode AND dc1.updateflag IN ('A','U','E'))) nd ON nd.hospdrugcode=d.icode 
            WHERE d.istatus = 'Y' AND d.`name` NOT LIKE '*%' AND d.`name` NOT LIKE '(ยาผู้ป่วย)%' AND d.`name` NOT LIKE 'ยาเดิมผู้ป่วย%' AND d.`name` NOT LIKE 'ยาเดิม%' AND d2.ref_code LIKE '4%'
            ORDER BY d.NAME,d.strength,d.units");
