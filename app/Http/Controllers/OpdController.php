...
class OpdController extends Controller
{
    ...
    public function oppp_visit(Request $request)
    {
        ...
        $visit_month = DB::connection('hosxp')->select('
            ...
            SUM(CASE WHEN hipdata_code IN ("UCS","WEL","DIS") AND paidst NOT IN ("01","03") AND incup = "Y" THEN 1 ELSE 0 END) AS "ucs_incup",
            SUM(CASE WHEN hipdata_code IN ("UCS","WEL","DIS") AND paidst NOT IN ("01","03") AND incup = "Y" THEN income ELSE 0 END) AS "ucs_incup_income",  
            SUM(CASE WHEN hipdata_code IN ("UCS","WEL","DIS") AND paidst NOT IN ("01","03") AND incup = "N" THEN 1 ELSE 0 END) AS "ucs_outcup",
            SUM(CASE WHEN hipdata_code IN ("UCS","WEL","DIS") AND paidst NOT IN ("01","03") AND incup = "N" THEN income ELSE 0 END) AS "ucs_outcup_income",  
            ...
            SUM(CASE WHEN hipdata_code IN ("NRD","NRH","FWF") AND paidst NOT IN ("01","03") THEN 1 ELSE 0 END) AS "fss",
            SUM(CASE WHEN hipdata_code IN ("NRD","NRH","FWF") AND paidst NOT IN ("01","03") THEN income ELSE 0 END) AS "fss_income",
            SUM(CASE WHEN hipdata_code IN ("NRD","NRH","FWF") AND paidst NOT IN ("01","03") THEN inc12 ELSE 0 END) AS "fss_inc_drug",
            SUM(CASE WHEN hipdata_code IN ("NRD","NRH","FWF") AND paidst NOT IN ("01","03") THEN inc03 ELSE 0 END) AS "fss_inc_lab",            
