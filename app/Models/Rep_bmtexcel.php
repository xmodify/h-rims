...
class Rep_bmtexcel extends Model
{
    use HasFactory;

    protected $table = 'rep_bmtexcel';
    ...
    protected $fillable = [
        ...
        'inst_opinst',
        'inst_ipinst',
        'ip_ipaec', 'ip_ipaer', 'ip_ipinrgc', 'ip_ipinrgr', 'ip_ipinspsn', 'ip_ipprcc', 'ip_ipprcc_puc', 'ip_ipbkk_inst', 'ip_ip_ontop',
