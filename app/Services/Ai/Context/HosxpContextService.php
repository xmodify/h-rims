        ...
        try {
                ...
                foreach (array_unique($extractedCodes) as $rawCode) {
                    ...
                    if ($row || $chi || $nhso) {
                        ...
                        $details[] = implode("\n", [
                            ...
                            "  - ประเภทบริการ (สปสช.): " . (($nhso->pp ?? '') === 'Y' ? 'สร้างเสริมสุขภาพและป้องกันโรค (PP)' : 'รักษาพยาบาลทั่วไป (OP)'),
            ...
            if ($isSummaryQuery || $force) {
                ...
                $lines = [
                    ...
                    "",
                    "• ประเภทบริการตามรหัสโรค (แยก OP / PP จากตาราง lookup_icd10):",
                    "  - รหัสสร้างเสริมสุขภาพและป้องกันโรค (PP): " . number_format($totalNhsoPp) . " รายการ (เช่น รหัสกลุ่ม Z คัดกรองความเสี่ยง ฉีดวัคซีน วางแผนครอบครัว)",
                    "  - รหัสอื่นๆ: ถือเป็นบริการรักษาพยาบาลทั่วไป (OP) ไม่ใช่เงื่อนไขข้อผิดพลาด",
                    "",
