...
-- ----------------------------
-- Table structure for aipn_drugcat
-- ----------------------------
DROP TABLE IF EXISTS `aipn_drugcat`;
CREATE TABLE `aipn_drugcat`  (
...
-- ----------------------------
-- Table structure for nhso_drugcat
-- ----------------------------
DROP TABLE IF EXISTS `nhso_drugcat`;
CREATE TABLE `nhso_drugcat`  (
