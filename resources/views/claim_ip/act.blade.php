        ...
        buttons: [
            {
              ...
              title: 'รายชื่อผู้มารับบริการ IP-พรบ. รอส่ง Claim วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}'
            }
        ],
        language: {
            search: "ค้นหา:",
        ...
        buttons: [
            {
              ...
              text: '<i class="bi bi-file-earmark-excel me-1"></i> Excel',
              className: 'btn btn-success btn-sm shadow-sm',
              title: 'รายชื่อผู้มารับบริการ IP-พรบ. ส่ง Claim วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}'
            }
        ],
        language: {
            search: "ค้นหา:",
      ...
      new Chart(document.querySelector('#sum_month'), {
        ...
        options: {
          ...
          plugins: {
            ...
            datalabels: {
              anchor: 'end',
              align: 'top', // Changed from 'end' to 'top' to match oppp_visit
              color: '#000',
              font: {
                weight: 'bold',
                size: 10
