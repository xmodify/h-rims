                ...
                <div class="filter-group">
                    <form id="form_indiv" method="POST" enctype="multipart/form-data" class="m-0 d-flex align-items-center">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <button type="button" class="btn text-white fw-bold px-3 shadow-sm" style="background: linear-gradient(135deg, #0e939a 0%, #15b7bd 100%); border: none;" onclick="exportSelectedF16Eclaim('OFC')">
                            ...
                            <tbody> 
                                ...
                                <tr>
                                    ...
                                    <td class="text-center small" data-order="{{ $row->rep_error ?: ($row->rep_error_code ?: '-') }}">
                                        ...
                                        @elseif(!empty($row->rep_error))
                                            <span class="badge bg-danger fw-bold" style="font-size: 0.72rem;" title="ข้อผิดพลาด: {{ $row->rep_error }}">
                                                {{ $row->rep_error }}
                                            </span>
                                        @else
