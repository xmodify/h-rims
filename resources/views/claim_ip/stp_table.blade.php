                ...
                <table id="t_visits" class="table table-modern w-100">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" rowspan="2">ความพร้อม</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if($row->is_sent == 'Y')
                                    ...
                                    @else
                                        <span class="badge bg-success-soft text-success py-0 text-truncate" style="font-size: 0.65rem; max-width: 75px; display: inline-block;" title="ส่งแล้ว">ส่งแล้ว</span>
                                    @endif
                                @else
                                    <span class="badge bg-warning text-dark py-0 px-1 text-truncate" style="font-size: 0.65rem; max-width: 75px; display: inline-block;" title="รอส่ง"><i class="bi bi-clock-history me-1"></i>รอส่ง</span>
                                @endif
                            </td>
                            ...
                            <td class="text-start ps-2">
                                <div class="d-flex flex-column align-items-start gap-1">
                                    <div class="d-flex align-items-center gap-1" style="font-size: 0.65rem; line-height: 1;">
                            ...
                            <td class="text-start">
                                ...
                                <div class="text-muted small" style="font-size: 0.7rem;">CID: {{$row->cid}}</div>
