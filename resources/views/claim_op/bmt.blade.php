...
#claim-tab.active {
    ...
    <x-import_hub_modal 
        ...
        :has-edc="false" 
        claim-title="สิทธิ OP-BMT (กทม. โอนสิทธิ)" 
    />
  ...
  <script>
            ...
            if (res.success) {
                ...
                var dt_search = $('#t_search').DataTable({
                    ...
                    buttons: [{
                        ...
                        title: 'รายชื่อผู้มารับบริการ OP-BMT รอส่ง Claim'
                    }],
                    language: {
                        search: "ค้นหา:",
                ...
                var dt_claim = $('#t_claim').DataTable({
                    ...
                    buttons: [{
                        ...
                        text: '<i class="bi bi-file-earmark-excel me-1"></i> Excel',
                        className: 'btn btn-success btn-sm shadow-sm',
                        title: 'รายชื่อผู้มารับบริการ OP-BMT ส่ง Claim แล้ว'
                    }],
                    language: {
                        search: "ค้นหา:",
                        lengthMenu: "แสดง _MENU_ รายการ",
    ...
    function exportSingleVnEclaim() {
        ...
        window.openF16EclaimExportModal({
            ...
            ans: [currentModalVn],
            claimCode: 'BMT',
            claimTitle: 'OP-BMT (กทม. รัฐวิสาหกิจ)',
            isIp: false
        });
    }
