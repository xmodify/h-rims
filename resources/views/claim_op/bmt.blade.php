    ...
    <div class="page-header-box mt-2 mb-3 d-flex justify-content-between align-items-center">
        <div>
            <h4 class="text-primary mb-0 fw-bold">
                ...
                สถิติการชดเชยค่าบริการ OP-BMT กรุงเทพมหานคร/รถไฟ
            </h4>
        </div>
...
<style>
/* Custom pastel background for main tabs in bmt */
#search-tab {
                    ...
                    <div class="card border-0 bg-light-soft h-100">
                      <div class="card-body py-2 px-3">
                        ...
                        <table class="table table-sm table-borderless mb-0 small compact-info-table">
                          ...
                          <tr><th class="text-muted">ชดเชย BMT</th><td class="text-success fw-bold">${parseFloat(visit.receive_total || 0).toFixed(2)} บาท</td></tr>
        ...
        buttons: [
            {
              ...
              title: 'รายชื่อผู้มารับบริการ OP-BMT กทม./รถไฟ รอส่ง Claim วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}'
            }
        ],
        language: {
            search: "ค้นหา:",
        ...
        buttons: [
            {
              ...
              text: '<i class="bi bi-file-earmark-excel me-1"></i> Excel',
              className: 'btn btn-success btn-sm shadow-sm',
              title: 'รายชื่อผู้มารับบริการ OP-BMT กทม./รถไฟ ส่ง Claim วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}'
            }
        ],
        language: {
            search: "ค้นหา:",
