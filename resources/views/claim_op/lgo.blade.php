...
@section('content')
    ...
    <x-import_hub_modal 
        :rep-url="url('import/rep_lgo')" 
        :stm-url="url('import/stm_lgo')" 
        :has-edc="false" 
        claim-title="สิทธิ OP-LGO (อปท.)" 
    />
...
<script>
    ...
    function exportSelectedF16LGO() {
        ...
        const tabTitle = activeTableId === '#t_claim' ? 'OP-LGO ส่ง Claim แล้ว' : 'OP-LGO รอส่ง Claim';
        window.openF16EclaimExportModal({
            vns: checkedVns,
            claimCode: 'LGO',
            claimTitle: `${tabTitle} (อปท. องค์กรปกครองส่วนท้องถิ่น)`
        });
    }
...
<script>
    ...
    function fetchData() {
        // Fallback for legacy onclick handlers.
    }
                  ...
                  buttons: [
                      {
                        ...
                        title: 'รายชื่อผู้มารับบริการ OP-LGO อปท. รอส่ง Claim วันที่ ' + start_date_val + ' ถึง ' + end_date_val
                      }
                  ],
                  language: {
                      search: "ค้นหา:",
                  ...
                  buttons: [
                      {
                        ...
                        text: '<i class="bi bi-file-earmark-excel me-1"></i> Excel',
                        className: 'btn btn-success btn-sm',
                        title: 'รายชื่อผู้มารับบริการ OP-LGO อปท. ส่ง Claim แล้ว วันที่ ' + start_date_val + ' ถึง ' + end_date_val
                      }
                  ],
                  language: {
                      search: "ค้นหา:",
