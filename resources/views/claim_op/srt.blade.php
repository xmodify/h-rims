...
/* Custom pastel background for main tabs in srt */
#search-tab {
...
#claim-tab.active {
    ...
    <div class="page-header-box mt-2 mb-3 d-flex justify-content-between align-items-center">
        <div>
            <h4 class="text-primary mb-0 fw-bold">
                ...
                สถิติการชดเชยค่าบริการ OP-SRT การรถไฟแห่งประเทศไทย
            </h4>
        </div>
    ...
    <x-import_hub_modal 
        :rep-url="url('import/rep_srt')" 
        :stm-url="url('import/stm_srt')" 
        :has-edc="false" 
        claim-title="สิทธิ OP-SRT (รถไฟ)" 
    />
...
@push('scripts')
  ...
  <script>
    ...
    function exportSelectedF16SRT() {
        ...
        const tabTitle = activeTableId === '#t_claim' ? 'OP-SRT ส่ง Claim แล้ว' : 'OP-SRT รอส่ง Claim';
        window.openF16EclaimExportModal({
            vns: checkedVns,
            claimCode: 'SRT',
            claimTitle: `${tabTitle} (การรถไฟแห่งประเทศไทย)`
        });
    }
            ...
            if (res.success) {
                ...
                var dt_search = $('#t_search').DataTable({
                    ...
                    buttons: [{
                        ...
                        title: 'รายชื่อผู้มารับบริการ OP-SRT รอส่ง Claim'
                    }],
                    language: {
                        search: "ค้นหา:",
                ...
                var dt_claim = $('#t_claim').DataTable({
                    ...
                    buttons: [{
                        ...
                        text: '<i class="bi bi-file-earmark-excel me-1"></i> Excel',
                        className: 'btn btn-success btn-sm shadow-sm',
                        title: 'รายชื่อผู้มารับบริการ OP-SRT ส่ง Claim แล้ว'
                    }],
                    language: {
                        search: "ค้นหา:",
                        lengthMenu: "แสดง _MENU_ รายการ",
    ...
    function exportSingleVnEclaim() {
        ...
        window.openF16EclaimExportModal({
            ...
            ans: [currentModalVn],
            claimCode: 'SRT',
            claimTitle: 'OP-SRT (การรถไฟแห่งประเทศไทย)',
            isIp: false
        });
    }
                    ...
                    <div class="card border-0 bg-light-soft h-100">
                      <div class="card-body py-2 px-3">
                        ...
                        <table class="table table-sm table-borderless mb-0 small compact-info-table">
                          ...
                          <tr><th class="text-muted">ชดเชย SRT</th><td class="text-success fw-bold">${parseFloat(visit.receive_total || 0).toFixed(2)} บาท</td></tr>
