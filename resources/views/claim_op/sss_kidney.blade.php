...
@section('content')
    ...
    <div class="page-header-box mt-2 mb-3 d-flex justify-content-between align-items-center">
        <div>
            <h4 class="text-primary mb-0 fw-bold">
                ...
                สถิติการชดเชยค่าบริการ SS-OP ประกันสังคม ฟอกไต
            </h4>
        </div>
    ...
    <div class="card dash-card border-0" style="height: auto !important; overflow: visible !important;">
        ...
        <!-- Section 2: Tabbed Data Table (Single Tab for current file) -->
        <div class="card-header bg-transparent border-0 pt-3 px-4 pb-0">
            <div class="d-flex justify-content-between align-items-end mb-3">
                <ul class="nav nav-tabs nav-tabs-modern border-0" id="claimTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="sent-tab" data-bs-toggle="tab" data-bs-target="#sent-pane" type="button" role="tab">
                            <i class="bi bi-list-stars me-2"></i>ข้อมูลผู้มารับบริการ
                        </button>
                    </li>
                </ul>
                        ...
                        <table id="t_claim" class="table table-modern w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-primary bg-primary-soft small">ชดเชย</th> 
                            ...
                            <tbody> 
                                ...
                                <tr>
                                    ...
                                    <td class="text-start small text-muted text-wrap" style="font-size: 0.65rem;">{{ $row->claim_list }}</td>
                                    ...
                                    <td class="text-end small fw-bold bg-primary-soft @if($row->receive_total-$row->claim_price > 0) text-success @elseif($row->receive_total-$row->claim_price < 0) text-danger @endif">
                            ...
                            <tfoot class="bg-light-soft">
                                <tr>
                                    ...
                                    <th class="text-end small fw-bold bg-primary-soft @if($sum_receive_total > 0) text-success @elseif($sum_receive_total < 0) text-danger @endif">
                                        {{ number_format($sum_receive_total,2) }}
                                    </th>
                                    <th class="text-end small fw-bold bg-primary-soft @if($sum_receive_total-$sum_claim_price > 0) text-success @elseif($sum_receive_total-$sum_claim_price < 0) text-danger @endif">
