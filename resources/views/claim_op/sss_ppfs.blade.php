...
#claim-tab.active {
    ...
    <x-import_hub_modal 
        ...
        :has-edc="false" 
        :has-fdh="false"
        claim-title="สิทธิ SS-OP ประกันสังคม PPFS (สปสช.)" 
    />
...
@push('scripts')
  ...
  <script>
    ...
    function exportSelectedF16SSSPPFS() {
        let checkedVns = [];
        ...
        const tabTitle = activeTableId === '#t_claim' ? 'OP-SSS PPFS ส่ง Claim แล้ว' : 'OP-SSS PPFS รอส่ง Claim';
        window.openF16EclaimExportModal({
            vns: checkedVns,
            claimCode: 'SSS_PPFS',
            claimTitle: `${tabTitle} (ประกันสังคม PPFS)`
        });
    }
    ...
    function exportSingleVnEclaim() {
        ...
        window.openF16EclaimExportModal({
            ...
            ans: [currentModalVn],
            claimCode: 'SS_PPFS',
            claimTitle: 'สิทธิ SS-OP ประกันสังคม PPFS (สปสช.)',
            isIp: false
        });
    }
