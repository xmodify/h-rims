                        ...
                        <table id="t_search" class="table table-modern w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center small">ประสงค์เบิก</th> 
                                    <th class="text-center small">พร้อมส่ง</th>   
                            ...
                            <tbody> 
                                ...
                                <tr>
                                    ...
                                    <td class="text-center fw-bold {{ $row->request_funds == 'Y' ? 'text-success' : 'text-danger' }}">{{ $row->request_funds }}</td>  
                                    <td class="text-center fw-bold {{ $row->confirm_and_locked == 'Y' ? 'text-success' : 'text-danger' }}">{{ $row->confirm_and_locked }}</td>
                                    <td class="text-start">
                        ...
                        <table id="t_claim" class="table table-modern w-100">
                            ...
                            <tfoot class="bg-light-soft">
                                <tr>
                                    ...
                                    <th class="text-end small">{{ number_format($sum_rcpt_money,2) }}</th>
                                    <th></th>
                                    <th class="text-end fw-bold text-primary small">{{ number_format($sum_ppfs,2) }}</th>
                                    <th></th>
