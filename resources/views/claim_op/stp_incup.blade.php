                        ...
                        <table id="t_search" class="table table-modern w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center small">รายการ PPFS</th>  
                            ...
                            <tbody> 
                                ...
                                <tr>
                                    ...
                                    <td class="text-start small text-muted text-wrap" style="max-width: 100px;">{{ $row->claim_list }}</td>   
                                ...
                                @php 
                                    ...
                                    $sum_claim_price_s += $row->claim_price; 
                                @endphp
                                @endforeach                 
                            </tbody>
                        ...
                        <table id="t_claim" class="table table-modern w-100">
                            ...
                            <tbody> 
                                ...
                                @php 
                                    ...
                                    $sum_ppfs_c += $row->ppfs; 
                                    $sum_claim_price_c += $row->claim_price; 
        ...
        buttons: [
            {
              ...
              text: '<i class="bi bi-file-earmark-excel me-1"></i> Excel',
              className: 'btn btn-success btn-sm shadow-sm',
              title: 'รายชื่อผู้มารับบริการ STP-OP บุคคลที่มีปัญหาสถานะและสิทธิ ใน CUP ส่ง Claim วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}'
            }
        ],
        language: {
            search: "ค้นหา:",
