...
@push('scripts')
  ...
  <script>
    let myChart = null;
    const VISIT_DETAILS_URL = "{{ url('claim_op/stp_outcup/visit_details') }}";
    ...
    function exportSingleVnFdh() {
        ...
        openF16FdhExportModal({
            vns: [currentModalVn],
            ans: [currentModalVn],
            claimCode: 'STP_OUTPROV',
            claimTitle: 'สิทธิบุคคลผู้มีปัญหาสถานะฯ (STP) นอก CUP',
            isIp: false
        });
    }
              ...
              window.patientItems = res.patient_items || [];
                ...
                var dt_visits = $('#t_visits').DataTable({
                    ...
                    buttons: [{
                        ...
                        title: 'รายชื่อผู้มารับบริการ STP-OP นอก CUP'
                    }],
                    language: {
                        search: "ค้นหา:",
                        lengthMenu: "แสดง _MENU_ รายการ",
    ...
    function exportSelectedF16FDH(claimCode) {
        ...
        openF16FdhExportModal({
            vns: selectedVns,
            claimCode: claimCode || 'STP_OUTPROV',
            claimTitle: 'สิทธิบุคคลผู้มีปัญหาสถานะฯ (STP) นอก CUP',
            isIp: false
        });
    }
