    ...
    <div class="page-header-box mt-2 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <div class="text-muted small mt-1">
                รายชื่อผู้มารับบริการ UC-OP ในจังหวัด วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}
            </div>
        </div>
                        ...
                        <table id="t_claim" class="table table-modern w-100">
                            ...
                            <tbody> 
                                ...
                                <tr>
                                    ...
                                    <td class="text-end small fw-bold" style="color: {{ ($row->receive_total - $row->uc_cr - $row->ppfs - $row->herb) >= 0 ? 'green' : 'red' }}">
                            ...
                            <tfoot class="bg-light-soft">
                                <tr>
                                    ...
                                    <th class="text-end small fw-bold" style="color: {{ ($sum_receive_total - $sum_uc_cr - $sum_ppfs - $sum_herb) >= 0 ? 'green' : 'red' }}">
                                        {{ number_format($sum_receive_total - $sum_uc_cr - $sum_ppfs - $sum_herb, 2) }}
                                    </th>
                                    <th></th>
                                </tr>
                            </tfoot>
