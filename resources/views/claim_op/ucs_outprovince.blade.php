...
#claim-tab.active {
    ...
    <x-import_hub_modal 
        ...
        :has-edc="false" 
        :has-fdh="true"
        claim-title="สิทธิ UC-OP นอกเขต (ต่างจังหวัด)" 
    />
  ...
  <script>
    ...
    function exportSingleVnFdh() {
        ...
        openF16FdhExportModal({
            vns: [currentModalVn],
            ans: [currentModalVn],
            claimCode: 'UCS_OUTPROV',
            claimTitle: 'สิทธิ UC-OP นอกเขต (ต่างจังหวัด)',
            isIp: false
        });
    }
    ...
    function exportSelectedF16FDH(claimCode) {
        ...
        openF16FdhExportModal({
            vns: selectedVns,
            claimCode: claimCode || 'UCS_OUTPROV',
            claimTitle: 'สิทธิ UC-OP ต่างจังหวัด',
            isIp: false
        });
    }
