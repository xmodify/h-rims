    ...
    <div class="page-header-box mt-2 mb-3 d-flex flex-column flex-md-row justify-content-between align-items-md-center flex-wrap">
        ...
        <div class="d-flex align-items-center gap-4">
            ...
            <div class="filter-group">
                <form method="POST" action="{{ url('debtor/1102050101_103') }}" enctype="multipart/form-data" class="m-0 d-flex flex-wrap align-items-center gap-2">
                    @csrf
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6 border-end">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control rounded-pill px-3 datepicker_th" data-hidden-id="charge_date_{{ $row->vn }}" value="{{ !empty($row->charge_date) ? DateThai($row->charge_date) : '' }}" placeholder="วว/ดด/ปปปป" autocomplete="off" readonly>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control rounded-pill px-3 border-success-soft datepicker_th" data-hidden-id="receive_date_{{ $row->vn }}" value="{{ !empty($row->receive_date) ? DateThai($row->receive_date) : '' }}" placeholder="วว/ดด/ปปปป" autocomplete="off" readonly>
                                    </div>
                                    <div class="mb-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('changeDate', '.datepicker_th', function(e) {
                ...
                if (hiddenInput.length === 0 && $(this).data('hidden-id')) {
