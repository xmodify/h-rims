...
@section('content')
    ...
    <div class="page-header-box mt-2 mb-3 d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center gap-4">
            ...
            <div class="filter-group">
                <form method="POST" action="{{ url('debtor/1102050101_103') }}" enctype="multipart/form-data" class="m-0 d-flex align-items-center gap-2">
                    @csrf
                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", function () {
                            ...
                            // --- 2. Modal Logic ---
                            // Because modals are pre-rendered with loop, we need to correct initial display values 
                            // (If value="YYYY-MM-DD", it might show as that initially until initialized or we set it manually)
                            // But bootstrap-datepicker-thai might not auto-convert initial value attribute on init if it's YYYY-MM-DD.
                            // So we iterate and setDate.
    ...
    <div class="card dash-card border-0" style="height: auto !important; overflow: visible !important;">
        ...
        <div class="card-body px-4 pb-4 pt-0">
            ...
            <form action="{{ url('debtor/1102050101_103_delete') }}" method="POST" enctype="multipart/form-data">
                @csrf   
                @method('DELETE')
                ...
                <table id="debtor" class="table table-bordered table-striped my-3" width="100%">
                    ...
                    <tr class="table-success">
                        <th class="text-left text-primary" colspan = "8">1102050101.103-ลูกหนี้ค่าตรวจสุขภาพ หน่วยงานภาครัฐ วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}</th> 
            ...
            <form action="{{ url('debtor/1102050101_103_confirm') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <table id="debtor_search" class="table table-bordered table-striped my-3" width="100%">
                    ...
                    <tr class="table-secondary">
                        <th class="text-left text-primary" colspan = "14">1102050101.103-ลูกหนี้ค่าตรวจสุขภาพ หน่วยงานภาครัฐ รอยืนยัน วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }} รอยืนยันลูกหนี้</th>                         
                    </tr>
                    <tr class="table-secondary">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6 border-end">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control rounded-pill px-3 datepicker_th_modal" data-hidden-id="charge_date_{{ $row->vn }}" data-date="{{ $row->charge_date ?? '' }}" placeholder="วว/ดด/ปปปป" autocomplete="off" readonly>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control rounded-pill px-3 border-success-soft datepicker_th_modal" data-hidden-id="receive_date_{{ $row->vn }}" data-date="{{ $row->receive_date ?? '' }}" placeholder="วว/ดด/ปปปป" autocomplete="off" readonly>
                                    </div>
                                    <div class="mb-3">
    ...
    <script>
        function confirmDelete() { 
            ...
            if (result.isConfirmed) {
                document.querySelector("form[action='{{ url('debtor/1102050101_103_delete') }}']").submit();
            }
        });
    }
</script>
...
<script>
    function confirmSubmit() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.querySelector("form[action='{{ url('debtor/1102050101_103_confirm') }}']").submit();
            }
        });
    }
</script>
