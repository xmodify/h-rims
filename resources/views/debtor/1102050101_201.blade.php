...
@section('content')
    ...
    <div class="page-header-box mt-2 mb-3 d-flex justify-content-between align-items-center">
        <div>
            <h4 class="text-primary mb-0 fw-bold">
                ...
                1102050101.201-เธฅเธนเธเธซเธเธตเนเธเนเธฒเธฃเธฑเธเธฉเธฒ UC-OP เนเธ CUP
            </h4>
        ...
        <div class="d-flex align-items-center gap-4">
            ...
            <div class="filter-group">
                <form method="POST" action="{{ url('debtor/1102050101_201') }}" enctype="multipart/form-data" class="m-0 d-flex align-items-center gap-2">
                    @csrf
    ...
    <div class="card dash-card border-0" style="height: auto !important; overflow: visible !important;">
        ...
        <div class="card-body px-4 pb-4 pt-0">
            ...
            <form action="{{ url('debtor/1102050101_201_delete') }}" method="POST" enctype="multipart/form-data">
                @csrf   
                @method('DELETE')
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <div>
                        <!-- Extra Button for 201 -->
                        <button type="button" class="btn btn-success btn-sm me-1" data-bs-toggle="modal" data-bs-target="#modalAverageReceive">
                             <i class="bi bi-calculator me-1"></i> เธเธฃเธฐเธ—เธเธขเธญเธ”เนเธเธเธเธฅเธธเนเธก
                        </button>
                        <a class="btn btn-outline-success btn-sm" href="{{ url('debtor/1102050101_201_indiv_excel')}}" target="_blank">
                             <i class="bi bi-file-earmark-excel me-1"></i> เธชเนเธเธญเธญเธเธฃเธฒเธขเธ•เธฑเธง
                        </a>                
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('debtor/1102050101_201_daily_pdf')}}" target="_blank">
                ...
                <table id="debtor" class="table table-bordered table-striped my-3" width="100%">
                    ...
                    <tr class="table-success">
                        <th class="text-left text-primary" colspan = "10">1102050101.201-เธฅเธนเธเธซเธเธตเนเธเนเธฒเธฃเธฑเธเธฉเธฒ UC-OP เนเธ CUP เธงเธฑเธเธ—เธตเน {{ DateThai($start_date) }} เธ–เธถเธ {{ DateThai($end_date) }}</th> 
            ...
            <form action="{{ url('debtor/1102050101_201_confirm') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <table id="debtor_search" class="table table-bordered table-striped my-3" width="100%">
                    ...
                    <tr class="table-secondary">
                        <th class="text-left text-primary" colspan = "13">1102050101.201-เธฅเธนเธเธซเธเธตเนเธเนเธฒเธฃเธฑเธเธฉเธฒ UC-OP เนเธ CUP เธฃเธญเธขเธทเธเธขเธฑเธ เธงเธฑเธเธ—เธตเน {{ DateThai($start_date) }} เธ–เธถเธ {{ DateThai($end_date) }} เธฃเธญเธขเธทเธเธขเธฑเธเธฅเธนเธเธซเธเธตเน</th>                         
                    </tr>
                    <tr class="table-secondary">
...
<!-- Modal เธเธฃเธฐเธ—เธเธขเธญเธ” (AJAX Version) -->
    <div class="modal fade" id="modalAverageReceive" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">        
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title">เธเธฃเธฐเธ—เธเธขเธญเธ”เนเธเธเธเธฅเธธเนเธก</h5>
                ...
                <form id="averageReceiveForm">
                    ...
                    <div class="modal-body">
                        <div class="mb-2">
                            <label>เธงเธฑเธเธ—เธตเนเน€เธฃเธดเนเธกเธ•เนเธ</label>
                            <input type="date" name="date_start" class="form-control" required>
                        </div>
                        <div class="mb-2">
                            <label>เธงเธฑเธเธ—เธตเนเธชเธดเนเธเธชเธธเธ”</label>
                            <input type="date" name="date_end" class="form-control" required>
                        </div>
                        <div class="mb-2">
                            <label>เน€เธฅเธเธ—เธตเนเนเธเน€เธชเธฃเนเธ</label>
                            <input type="text" name="repno" class="form-control" required>
                        </div>
                        <div class="mb-2">
                            <label>เธขเธญเธ”เธเธ”เน€เธเธข (เธเธฒเธ—)</label>
                            <input type="number" step="0.01" name="total_receive" class="form-control" required>
                        </div>
                        <!-- เธเนเธญเธเธงเธฒเธกเธเธฅเธฅเธฑเธเธเน -->
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success" id="avgSubmitBtn">เธขเธทเธเธขเธฑเธ</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        function confirmDelete() { 
            ...
            cancelButtonText: 'เธขเธเน€เธฅเธดเธ'
                ...
                if (result.isConfirmed) {
                    document.querySelector("form[action='{{ url('debtor/1102050101_201_delete') }}']").submit();
                }
            });
        }
    </script>
    ...
    <script>
        function confirmSubmit() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.querySelector("form[action='{{ url('debtor/1102050101_201_confirm') }}']").submit();
                }
            });
        }
    </script>
...
@push('scripts')
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // เน€เธเธดเธ” modal โ’ reset form
            ...
            form.addEventListener("submit", function(e){
                ...
                fetch("{{ url('debtor/1102050101_201_average_receive') }}", {
                    method: "POST",
                    body: data // เธซเนเธฒเธกเนเธชเน headers
                })
                .then(res => res.json())
                .then(response => {
                    Swal.fire({
                        ...
                        // โ… เธเธดเธ” modal เนเธเธเนเธกเนเธกเธต bsModal instance
                        $("#modalAverageReceive").modal("hide");
                        // โ… reload เธซเธเนเธฒเน€เธกเธทเนเธญ modal เธเธดเธ”เธเธฃเธดเธ
                ...
                .catch(err => {
                    Swal.fire("Error", "เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เน€เธเธทเนเธญเธกเธ•เนเธญเน€เธเธดเธฃเนเธเน€เธงเธญเธฃเนเนเธ”เน", "error");
                });
            });
        });
    </script>
    ...
    <script>
        ...
        $('#debtor_search').DataTable({
            ...
            buttons: [
                ...
                title: '1102050101.201-เธฅเธนเธเธซเธเธตเนเธเนเธฒเธฃเธฑเธเธฉเธฒ UC-OP เนเธ CUP เธฃเธญเธขเธทเธเธขเธฑเธ เธงเธฑเธเธ—เธตเน {{ DateThai($start_date) }} เธ–เธถเธ {{ DateThai($end_date) }}'
                }
            ],
            language: {
