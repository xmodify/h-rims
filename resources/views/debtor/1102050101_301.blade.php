    ...
    <div class="page-header-box mt-2 mb-3 d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center gap-4">
            ...
            <div class="filter-group">
                <form method="POST" action="{{ url('debtor/1102050101_301') }}" enctype="multipart/form-data" class="m-0 d-flex align-items-center gap-2">
                    @csrf
                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", function () {
                            ...
                            // --- 2. Modal Logic (Average Receive) ---
                             // Note: Initializing datepicker for modal inputs when modal opens or on doc ready
                             // But since they have class .datepicker_th, they are already initialized above.
                             // We just need the sync logic.
