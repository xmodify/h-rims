                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-6 mb-0">
                                    <label class="form-label mb-1 small fw-bold">REP</label>
                                    <input type="text" class="form-control form-control-sm rounded-pill px-3" name="repno" id="modal_repno" placeholder="ระบุREP">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#debtor_search').DataTable({
                ...
                buttons: [{ extend: 'excelHtml5', text: 'Excel', className: 'btn btn-success btn-sm', title: '1102050101.308-ลูกหนี้ค่ารักษา ประกันสังคม 72 ชั่วโมงแรก รอยืนยัน' }],
