...
@section('content')
    ...
    <div class="page-header-box mt-2 mb-3 d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center gap-4">
            ...
            <div class="filter-group">
                <form method="POST" action="{{ url('debtor/1102050101_310') }}" enctype="multipart/form-data" class="m-0 d-flex align-items-center gap-2">
                    @csrf
    ...
    <div class="card dash-card border-0">
        ...
        <div class="card-body px-4 pb-4 pt-0">
            ...
            <form action="{{ url('debtor/1102050101_310_delete') }}" method="POST" enctype="multipart/form-data">
                @csrf   
                @method('DELETE')
            ...
            <form action="{{ url('debtor/1102050101_310_confirm') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <div id="receive-{{ str_replace(['/', '.'], '-', $row->an) }}" class="modal fade" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content border-0 shadow-lg">
                        ...
                        <form action="{{ url('debtor/1102050101_310/update', $row->an) }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6 border-end">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control rounded-pill px-3 datepicker_th" data-hidden-id="charge_date_{{ $row->an }}" value="{{ !empty($row->charge_date) ? DateThai($row->charge_date) : '' }}" placeholder="วว/ดด/ปปปป" autocomplete="off" readonly>
                                        </div>
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control rounded-pill px-3 border-success-soft datepicker_th" data-hidden-id="receive_date_{{ $row->an }}" value="{{ !empty($row->receive_date) ? DateThai($row->receive_date) : '' }}" placeholder="วว/ดด/ปปปป" autocomplete="off" readonly>
                                        </div>
                                        <div class="mb-3">
