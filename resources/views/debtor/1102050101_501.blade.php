                    ...
                    <form id="form-delete" action="{{ url('debtor/1102050101_501_delete') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="table-responsive"><table id="debtor" class="table table-bordered table-striped my-3" width="100%">
                            ...
                            <tr class="table-success">
                                <th class="text-left text-primary" colspan = "8">1102050101.501-ลูกหนี้ค่ารักษา คนต่างด้าวและแรงงานต่างด้าว OP วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}</th> 
