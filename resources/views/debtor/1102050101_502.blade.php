                    ...
                    <form action="{{ url('debtor/1102050101_502_confirm') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <table id="debtor_search" class="table table-bordered table-striped my-3" width="100%">
                            ...
                            <tr class="table-secondary">
                                <th class="text-left text-primary" colspan = "18">1102050101.502-ลูกหนี้ค่ารักษา คนต่างด้าวและแรงงานต่างด้าว IP รอยืนยัน วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }} รอยืนยันลูกหนี้</th>                         
                            </tr>
                            <tr class="table-secondary">
                    ...
                    <div class="modal-content border-0 shadow-lg">
                        <div class="modal-header bg-primary text-white border-0 py-3">
                            <h5 class="modal-title d-flex align-items-center">
                                ...
                                รายการการชดเชยเงิน/ลูกหนี้ (VN/AN: {{ $row->an }})
                            </h5>
