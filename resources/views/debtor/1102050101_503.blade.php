        ...
        <div style="overflow-x:auto;">
            ...
            <table class="table table-bordered " width="100%">
                ...
                <tr>
                    ...
                    <td align="center">
                        <a class="btn btn-outline-success btn-sm" href="{{ url('debtor/1102050101_503_indiv_excel')}}" target="_blank">ส่งออกรายตัว</a>                
        ...
        function confirmDelete() { 
            ...
            cancelButtonText: 'ยกเลิก'
                ...
                if (result.isConfirmed) {
                    document.querySelector("form[action='{{ url('debtor/1102050101_503_delete') }}']").submit();
                }
            });
        }
    </script>
    ...
    <script>
        function confirmSubmit() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.querySelector("form[action='{{ url('debtor/1102050101_503_confirm') }}']").submit();
                }
            });
        }
    </script>
