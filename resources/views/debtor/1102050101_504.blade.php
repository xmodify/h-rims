    ...
    <div class="page-header-box mt-2 mb-3 d-flex justify-content-between align-items-center">
        <div>
            <h4 class="text-primary mb-0 fw-bold">
                ...
                1102050101.504-เธฅเธนเธเธซเธเธตเนเธเนเธฒเธฃเธฑเธเธฉเธฒ เธเธเธ•เนเธฒเธเธ”เนเธฒเธงเนเธฅเธฐเนเธฃเธเธเธฒเธเธ•เนเธฒเธเธ”เนเธฒเธง IP เธเธญเธ CUP
            </h4>
        ...
        <div class="card-body px-4 pb-4 pt-0">
            <div class="tab-content" id="myTabContent">
                    ...
                    <form action="{{ url('debtor/1102050101_504_delete') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <table id="debtor" class="table table-bordered table-striped my-3" width="100%">
                            ...
                            <tr class="table-success">
                                <th class="text-left text-primary" colspan = "12">1102050101.504-เธฅเธนเธเธซเธเธตเนเธเนเธฒเธฃเธฑเธเธฉเธฒ เธเธเธ•เนเธฒเธเธ”เนเธฒเธงเนเธฅเธฐเนเธฃเธเธเธฒเธเธ•เนเธฒเธเธ”เนเธฒเธง IP เธเธญเธ CUP เธงเธฑเธเธ—เธตเน {{ DateThai($start_date) }} เธ–เธถเธ {{ DateThai($end_date) }}</th> 
                ...
                <div class="tab-pane fade" id="confirm-pane" role="tabpanel"> 
                    <form action="{{ url('debtor/1102050101_504_confirm') }}" method="POST" enctype="multipart/form-data">
                        @csrf                
                        <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <table id="debtor_search" class="table table-bordered table-striped my-3" width="100%">
                            ...
                            <tr class="table-secondary">
                                <th class="text-left text-primary" colspan = "18">1102050101.504-เธฅเธนเธเธซเธเธตเนเธเนเธฒเธฃเธฑเธเธฉเธฒ เธเธเธ•เนเธฒเธเธ”เนเธฒเธงเนเธฅเธฐเนเธฃเธเธเธฒเธเธ•เนเธฒเธเธ”เนเธฒเธง IP เธเธญเธ CUP เธฃเธญเธขเธทเธเธขเธฑเธ เธงเธฑเธเธ—เธตเน {{ DateThai($start_date) }} เธ–เธถเธ {{ DateThai($end_date) }} เธฃเธญเธขเธทเธเธขเธฑเธเธฅเธนเธเธซเธเธตเน</th>                         
                            </tr>
                            <tr class="table-secondary">
            ...
            <div id="receive-{{ $row->an }}" class="modal fade" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content border-0 shadow-lg">
                        ...
                        <form action="{{ url('debtor/1102050101_504/update', $row->an) }}" method="POST">
                            @csrf
                            @method('PUT')
        ...
        function confirmDelete() { 
            ...
            cancelButtonText: 'เธขเธเน€เธฅเธดเธ'
                ...
                if (result.isConfirmed) {
                    document.querySelector("form[action='{{ url('debtor/1102050101_504_delete') }}']").submit();
                }
            });
        }
    </script>
    ...
    <script>
        function confirmSubmit() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.querySelector("form[action='{{ url('debtor/1102050101_504_confirm') }}']").submit();
                }
            });
        }
    </script>
    ...
    <script>
        ...
        $('#debtor_search').DataTable({
            ...
            buttons: [
                ...
                title: '1102050101.504-เธฅเธนเธเธซเธเธตเนเธเนเธฒเธฃเธฑเธเธฉเธฒ เธเธเธ•เนเธฒเธเธ”เนเธฒเธงเนเธฅเธฐเนเธฃเธเธเธฒเธเธ•เนเธฒเธเธ”เนเธฒเธง IP เธเธญเธ CUP เธฃเธญเธขเธทเธเธขเธฑเธ เธงเธฑเธเธ—เธตเน {{ DateThai($start_date) }} เธ–เธถเธ {{ DateThai($end_date) }}'
                }
            ],
            language: {
