    ...
    <div class="page-header-box mt-2 mb-3 d-flex justify-content-between align-items-center">
        <div>
            <h4 class="text-primary mb-0 fw-bold">
                ...
                1102050101.701-เธฅเธนเธเธซเธเธตเนเธเนเธฒเธฃเธฑเธเธฉเธฒ เธเธธเธเธเธฅเธ—เธตเนเธกเธตเธเธฑเธเธซเธฒเธชเธ–เธฒเธเธฐเนเธฅเธฐเธชเธดเธ—เธเธด OP เนเธ CUP
            </h4>
        ...
        <div class="d-flex align-items-center gap-4">
            ...
            <div class="filter-group">
                <form method="POST" action="{{ url('debtor/1102050101_701') }}" enctype="multipart/form-data" class="m-0 d-flex align-items-center gap-2">
                    @csrf
                    ...
                    <form id="form-delete" action="{{ url('debtor/1102050101_701_delete') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <table id="debtor" class="table table-bordered table-striped my-3" width="100%">
                            ...
                            <tr class="table-success">
                                <th class="text-left text-primary" colspan = "10">1102050101.701-เธฅเธนเธเธซเธเธตเนเธเนเธฒเธฃเธฑเธเธฉเธฒ เธเธธเธเธเธฅเธ—เธตเนเธกเธตเธเธฑเธเธซเธฒเธชเธ–เธฒเธเธฐเนเธฅเธฐเธชเธดเธ—เธเธด OP เนเธ CUP เธงเธฑเธเธ—เธตเน {{ DateThai($start_date) }} เธ–เธถเธ {{ DateThai($end_date) }}</th> 
                    ...
                    <form id="form-confirm" action="{{ url('debtor/1102050101_701_confirm') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <table id="debtor_search" class="table table-bordered table-striped my-3" width="100%">
                            ...
                            <tr class="table-secondary">
                                <th class="text-left text-primary" colspan = "13">1102050101.701-เธฅเธนเธเธซเธเธตเนเธเนเธฒเธฃเธฑเธเธฉเธฒ เธเธธเธเธเธฅเธ—เธตเนเธกเธตเธเธฑเธเธซเธฒเธชเธ–เธฒเธเธฐเนเธฅเธฐเธชเธดเธ—เธเธด OP เนเธ CUP เธฃเธญเธขเธทเธเธขเธฑเธ เธงเธฑเธเธ—เธตเน {{ DateThai($start_date) }} เธ–เธถเธ {{ DateThai($end_date) }} เธฃเธญเธขเธทเธเธขเธฑเธเธฅเธนเธเธซเธเธตเน</th>                         
                            </tr>
                            <tr class="table-secondary">
    ...
    <script>
        ...
        $('#debtor_search').DataTable({
            ...
            buttons: [
                ...
                title: '1102050101.701-เธฅเธนเธเธซเธเธตเนเธเนเธฒเธฃเธฑเธเธฉเธฒ เธเธธเธเธเธฅเธ—เธตเนเธกเธตเธเธฑเธเธซเธฒเธชเธ–เธฒเธเธฐเนเธฅเธฐเธชเธดเธ—เธเธด OP เนเธ CUP เธฃเธญเธขเธทเธเธขเธฑเธ เธงเธฑเธเธ—เธตเน {{ DateThai($start_date) }} เธ–เธถเธ {{ DateThai($end_date) }}'
                }
            ],
            language: {
