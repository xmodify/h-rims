    ...
    <div class="container-fluid">        
        ...
        <div style="overflow-x:auto;">
            ...
            <table class="table table-bordered " width="100%">
                ...
                <tr>
                    ...
                    <td align="center">
                        <a class="btn btn-outline-success btn-sm" href="{{ url('debtor/1102050102_106_indiv_excel')}}" target="_blank">ส่งออกรายตัว</a>                
        ...
        <div class="tab-content pt-2" id="myTabContent">
            ...
            <div class="tab-pane fade" id="iclaim" role="tabpanel" aria-labelledby="iclaim-tab">
                <div style="overflow-x:auto;">
                    <form action="{{ url('debtor/1102050102_106_confirm_iclaim') }}" method="POST" enctype="multipart/form-data"> 
                        @csrf                
        ...
        <div id="receive-{{ $row->vn }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="receive-{{ $row->vn }}" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form action={{ url('debtor/1102050102_106/update', $row->vn) }} method="POST">
                    @csrf
                    @method('PUT')
        ...
        function confirmDelete() { 
            ...
            cancelButtonText: 'ยกเลิก'
                ...
                if (result.isConfirmed) {
                    document.querySelector("form[action='{{ url('debtor/1102050102_106_delete') }}']").submit();
                }
            });
        }
    </script>
    ...
    <script>
        function confirmSubmit() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.querySelector("form[action='{{ url('debtor/1102050102_106_confirm') }}']").submit();
                }
            });
        }
    </script>
    <script>
        function confirmSubmit_iclaim() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.querySelector("form[action='{{ url('debtor/1102050102_106_confirm_iclaim') }}']").submit();
                }
            });
        }
    </script>
