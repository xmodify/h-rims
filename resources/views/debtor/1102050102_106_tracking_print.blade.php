...
<body>
    ...
    <div class="letter-container">
        ...
        <div class="letter-content">
            ตามที่ ท่านได้เข้ามารับการตรวจรักษาพยาบาล ณ {{ $hospital_name }} เมื่อวันที่ {{ DateThai($debtor->vstdate) }} ด้วยสิทธิการรักษา {{ preg_replace('/^\d+\s*/', '', $debtor->pttype) }} โดยมีค่าบริการทางการแพทย์และค่ารักษาพยาบาลทั้งหมดรวมเป็นเงินทั้งสิ้น {{ number_format($debtor->income, 2) }} บาท ซึ่งมีส่วนที่ต้องชำระเอง/ค้างชำระตามสิทธิเป็นจำนวนเงิน <strong>{{ number_format($debtor->debtor, 2) }} บาท ({{ convert(number_format($debtor->debtor, 2, '.', '')) }})</strong> นั้น
        </div>

        <div class="letter-content">
            เนื่องจากขณะนี้เลยกำหนดระยะเวลาการชำระเงินมาแล้ว ทาง{{ $hospital_name }}จึงขอความร่วมมือจากท่านโปรดติดต่อชำระเงินค้างชำระจำนวนดังกล่าว ณ งานการเงินและบัญชี{{ $hospital_name }} ภายใน 15 วัน นับจากวันที่ได้รับหนังสือฉบับนี้ หากท่านได้ชำระเรียบร้อยแล้วต้องขออภัยมา ณ ที่นี้ หรือมีข้อสงสัยประการใดกรุณาติดต่อสอบถามกับทางโรงพยาบาลโดยตรง โทร {{ $hospital_phone_finance }}
        </div>
