...
<body>
    ...
    <div class="letter-container">
        ...
        <div class="letter-content">
            เนื่องจากขณะนี้เลยกำหนดระยะเวลาการชำระเงินมาแล้ว ทาง{{ $hospital_name }}จึงขอความร่วมมือจากท่านโปรดติดต่อชำระเงินค้างชำระจำนวนดังกล่าว ณ งานการเงินและบัญชี ของ{{ $hospital_name }} ภายใน 15 วัน นับจากวันที่ได้รับหนังสือฉบับนี้ หากท่านได้ดำเนินการชำระเงินเรียบร้อยแล้ว หรือมีข้อสงสัยประการใด กรุณาติดต่อสอบถามได้ที่งานสิทธิประโยชน์และหนี้สิน โทร. {{ $debtor->mobile_phone_number ?: '.........................' }} (เบอร์โทรผู้ป่วยที่ให้ไว้: {{ $debtor->mobile_phone_number ?: '-' }}) หรือติดต่อทางโรงพยาบาลโดยตรง
        </div>
