...
<body>
    ...
    <div class="letter-container">
        ...
        <div class="letter-content">
            เนื่องจากขณะนี้เลยกำหนดระยะเวลาการชำระเงินมาแล้ว ทาง{{ $hospital_name }}จึงขอความร่วมมือจากท่านโปรดติดต่อชำระเงินค้างชำระจำนวนดังกล่าว ณ งานการเงินและบัญชี{{ $hospital_name }} ภายใน 15 วัน นับจากวันที่ได้รับหนังสือฉบับนี้ หากท่านได้ดำเนินการชำระเงินเรียบร้อยแล้ว หรือมีข้อสงสัยประการใดกรุณาติดต่อสอบถามกับทางโรงพยาบาลโดยตรง โทร {{ $hospital_phone_finance }}
        </div>
