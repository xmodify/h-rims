    ...
    <div class="row justify-content-center">            
        <table width="100%" border="1">
            ...
            <tr>
                ...
                <th class="text-center text-primary">สถานะ Lock</th>
            </tr>     
            </thead> 
            <?php $count = 1 ; ?>
            <?php $sum_income = 0 ; ?>
            ...
            <tr>
                ...
                <td align="center" style='mso-number-format:"@"'>{{ $row->an }}</td>
                ...
                <td align="center">@if($row->debtor_lock == 'Y') Lock @else - @endif</td>
            </tr>                
            <?php $count++; ?>
