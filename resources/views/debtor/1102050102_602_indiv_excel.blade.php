    ...
    <div class="row justify-content-center">            
        <table width="100%" >
            ...
            <tr>
                ...
                <td align="right"><strong>{{number_format($s_adj_inc,2)}}&nbsp;</strong></td> 
                <td align="right"><strong>{{number_format($s_adj_dec,2)}}&nbsp;</strong></td> 
                <td align="right"><strong>{{number_format($s_balance,2)}}&nbsp;</strong></td>
                <td colspan="2"></td>
            </tr>          
        </table> 
    </div>
