...
@section('content')
    <div class="container-fluid">        
        ...
        <div style="overflow-x:auto;">
            <form action="{{ url('debtor/1102050102_801_delete') }}" method="POST" enctype="multipart/form-data">
                @csrf   
                @method('DELETE')
            ...
            <table class="table table-bordered ">
                ...
                <tr>
                    ...
                    <td align="center">
                        <a class="btn btn-outline-success btn-sm" href="{{ url('debtor/1102050102_801_indiv_excel')}}" target="_blank">ส่งออกรายตัว</a>                
        ...
        <hr>
        <div style="overflow-x:auto;">
            <form action="{{ url('debtor/1102050102_801_confirm') }}" method="POST" enctype="multipart/form-data">
                @csrf                
        ...
        function confirmDelete() { 
            ...
            cancelButtonText: 'ยกเลิก'
                ...
                if (result.isConfirmed) {
                    document.querySelector("form[action='{{ url('debtor/1102050102_801_delete') }}']").submit();
                }
            });
        }
    </script>
    ...
    <script>
        function confirmSubmit() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.querySelector("form[action='{{ url('debtor/1102050102_801_confirm') }}']").submit();
                }
            });
        }
    </script>
