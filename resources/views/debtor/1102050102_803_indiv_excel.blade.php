    ...
    <div class="row justify-content-center">            
        <table width="100%" >
            ...
            <tr>
                ...
                <td align="right">{{ number_format($row->ofc ?? 0, 2) }}</td>
                ...
                <td align="right">{{ number_format(($row->receive + ($row->adj_inc ?? 0) - ($row->adj_dec ?? 0)) - $row->debtor, 2) }}</td>
                <td align="center" style='mso-number-format:"@"'>{{ $row->repno }} {{ $row->repno_ofc }} {{ $row->rid }} {{ $row->rid_hd }}</td>
            ...
            <tr>
                ...
                <td align="right"><strong>{{number_format($sum_receive + $sum_adj_inc - $sum_adj_dec - $sum_debtor, 2)}}&nbsp;</strong></td> 
            </tr>          
        </table> 
    </div>
</div>    
