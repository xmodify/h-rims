                        ...
                        <table class="table table-hover table-modern align-middle mb-0">
                            <tbody>   
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_103') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_109') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_201') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_203') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_209') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_216') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_301') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_303') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_307') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_309') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_401') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_501') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_503') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_701') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_702') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050102_106') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050102_108') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050102_110') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050102_602') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050102_801') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050102_803') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                        ...
                        <table class="table table-hover table-modern align-middle mb-0">
                            <tbody>   
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_202') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_217') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_302') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_304') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_308') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_310') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_402') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_502') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_504') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050101_704') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050102_107') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050102_109') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050102_111') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050102_603') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050102_802') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ url('debtor/1102050102_804') }}" target="_blank" class="text-decoration-none text-dark d-block py-1">
