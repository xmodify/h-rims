    ...
    <div class="row g-4 mb-4">
        <div class="col-lg-5">
            <div class="card dash-card h-100">
                <div class="card-body">
                    <form id="importForm" action="{{ url('import/drugcat_fdh_save') }}" method="POST" enctype="multipart/form-data" class="m-0">
                        @csrf  
            ...
            <div class="card dash-card h-100">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <a class="btn btn-outline-primary btn-sm rounded-pill px-3" href="{{ url('import/drugcat_fdh') }}">
                            <i class="bi bi-list-check me-1"></i> ทั้งหมด
                        </a>  
                        <a class="btn btn-outline-purple btn-sm rounded-pill px-3" href="{{ url('import/drugcat_fdh_non_nhso') }}">
                            <i class="bi bi-search me-1"></i> ไม่พบที่ FDH
                        </a>  
                        <a class="btn btn-outline-purple btn-sm rounded-pill px-3" href="{{ url('import/drugcat_fdh_price_notmatch_hosxp') }}">
                            <i class="bi bi-currency-dollar me-1"></i> ราคาไม่ตรง
                        </a> 
                        <a class="btn btn-outline-purple btn-sm rounded-pill px-3" href="{{ url('import/drugcat_fdh_tmt_notmatch_hosxp') }}">
                            <i class="bi bi-upc-scan me-1"></i> TMT ไม่ตรง
                        </a> 
                        <a class="btn btn-outline-purple btn-sm rounded-pill px-3" href="{{ url('import/drugcat_fdh_code24_notmatch_hosxp') }}">
                            <i class="bi bi-hash me-1"></i> 24 หลักไม่ตรง
                        </a> 
                        <a class="btn btn-outline-purple btn-sm rounded-pill px-3" href="{{ url('import/drugcat_fdh_herb') }}">
                            <i class="bi bi-leaf me-1"></i> ยาสมุนไพร
                        </a>
                        <a class="btn btn-outline-purple btn-sm rounded-pill px-3" href="{{ url('import/drugcat_fdh_ised_notmatch_hosxp') }}">
                            <i class="bi bi-exclamation-triangle me-1"></i> บัญชียา ED/NED ไม่ตรง
                        </a>
                        <a class="btn btn-outline-purple btn-sm rounded-pill px-3" href="{{ url('import/drugcat_fdh_code24_missing_hosxp') }}">
                            <i class="bi bi-patch-question me-1"></i> ยังไม่ผูก 24 หลัก
                        </a>
                        <a class="btn btn-outline-purple btn-sm rounded-pill px-3" href="{{ url('import/drugcat_fdh_tmt_missing_hosxp') }}">
...
@push('scripts')  
  <script>
    ...
    function exportData(type) {
        ...
        fetch('{{ url("import/drugcat_fdh_export_preview") }}', {
            method: 'POST',
            headers: {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('confirmExportBtn').addEventListener('click', function() {
            ...
            let baseUrl = '{{ url("import/drugcat_fdh_export") }}';
