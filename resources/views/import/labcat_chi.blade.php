        ...
        <div class="col-lg-5">
            <div class="card dash-card h-100">
                <div class="card-body">
                    ...
                    <form id="importForm" action="{{ url('import/labcat_chi_save') }}" method="POST" enctype="multipart/form-data" class="m-0">
                        @csrf  
            ...
            <div class="card dash-card h-100">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <a class="btn btn-outline-primary btn-sm rounded-pill px-3" href="{{ url('import/labcat_chi') }}">
                            <i class="bi bi-list-check me-1"></i> ทั้งหมด
                        </a>  
                        <a class="btn btn-outline-purple btn-sm rounded-pill px-3" href="{{ url('import/labcat_chi_non_nhso') }}">
                            <i class="bi bi-search me-1"></i> ไม่พบที่ สกส.
                        </a>  
                        <a class="btn btn-outline-purple btn-sm rounded-pill px-3" href="{{ url('import/labcat_chi_price_notmatch_hosxp') }}">
                            <i class="bi bi-currency-dollar me-1"></i> ราคาไม่ตรง
                        </a> 
                        <a class="btn btn-outline-purple btn-sm rounded-pill px-3" href="{{ url('import/labcat_chi_tmlt_notmatch_hosxp') }}">
                            <i class="bi bi-upc-scan me-1"></i> TMLT ไม่ตรง
                        </a> 
                        <a class="btn btn-outline-purple btn-sm rounded-pill px-3" href="{{ url('import/labcat_chi_loinc_notmatch_hosxp') }}">
                            <i class="bi bi-hash me-1"></i> LOINC ไม่ตรง
                        </a> 
                        <a class="btn btn-outline-purple btn-sm rounded-pill px-3" href="{{ url('import/labcat_chi_tmlt_missing_hosxp') }}">
                            <i class="bi bi-patch-question me-1"></i> ยังไม่ผูก TMLT
                        </a>
                        <a class="btn btn-outline-purple btn-sm rounded-pill px-3" href="{{ url('import/labcat_chi_loinc_missing_hosxp') }}">
...
@push('scripts')  
  <script>
    ...
    function exportData(type) {
        ...
        fetch('{{ url("import/labcat_chi_export_preview") }}', {
            method: 'POST',
            headers: {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('confirmExportBtn').addEventListener('click', function() {
            ...
            let baseUrl = '{{ url("import/labcat_chi_export") }}';
