                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold mb-0" id="eclaimRepBotModalLabel">
                            ดึงข้อมูลการตรวจสอบเบื้องต้น (REP BMT (สิทธิ์พนักงาน ขสมก.)) จาก e-Claim อัตโนมัติ
                        </h5>
                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                    <div class="card-header bg-white py-2.5 px-3 d-flex justify-content-between align-items-center">
                        <div class="fw-bold small text-dark d-flex align-items-center gap-2">
                            <i class="bi bi-list-task text-success"></i> รายการ REP ที่พบใน e-Claim (REP BMT (สิทธิ์พนักงาน ขสมก.))
                        </div>
...
@push('scripts')
  <script>
        ...
        // ==========================================
        // e-Claim REP Automation (bmt)
        // ==========================================
        var repMaininscl = 'bmt';
