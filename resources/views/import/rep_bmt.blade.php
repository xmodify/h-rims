                ...
                <div class="card-body p-4">
                    <form id="importForm" onsubmit="simulateProcess(event)" action="{{ url('import/rep_bmt_save') }}" method="POST" enctype="multipart/form-data" class="m-0">
                        ...
                        <div class="input-group mb-0">
                            ...
                            <button class="btn btn-warning text-white px-3.5" type="submit" style="border-radius: 0;">
...
@push('scripts')
  <script>
        ...
        $(document).ready(function () {
            ...
            var repTable = $('#rep_bmt_table').DataTable({
                ordering: false,
                dom: '<"row mb-3"' +
                        '<"col-md-6"l>' +
            ...
            $.fn.dataTable.ext.search.push(
                function(settings, data, dataIndex, rowData, counter) {
                    if (settings.sTableId !== 'rep_bmt_table') return true;
