                ...
                <table id="rep_ucs" class="table table-modern w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end text-danger fw-bold">
                                @if($row->count_fail > 0)
                                    <a href="javascript:void(0)" class="text-danger fail-link text-decoration-underline"
                                       data-filename="{{ $row->rep_filename }}"
                                       data-type="{{ $row->dep }}"
                                       data-repno="{{ $row->repno }}">
                                        {{ number_format($row->count_fail) }}
                                    </a>
                                @else
                    ...
                    <tfoot>
                        <tr class="fw-bold bg-light" style="border-top: 2px solid #dee2e6 !important;">
                            ...
                            <td class="text-end text-danger">{{ number_format($total_fail) }}</td>
