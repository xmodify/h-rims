                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold mb-0" id="eclaimRepBotModalLabel">
                            ดึงข้อมูลการตรวจสอบเบื้องต้น (REP UCS) จาก e-Claim อัตโนมัติ
                        </h5>
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-muted small" id="eclaimRepAuthStatusSub">เปิดเว็บ e-Claim ใน Chrome แล้วกดปุ่ม "ซิงก์ Session เข้า RiMS" ใน Extension เพื่อเชื่อมต่อ</div>
                                </div>
                            </div>
                            <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="card-body p-3">
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control form-control-sm rounded-3" id="botRepNoFilter" placeholder="เช่น 690800067">
                            </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                    <div class="card-header bg-white py-2.5 px-3 d-flex justify-content-between align-items-center">
                        <div class="fw-bold small text-dark d-flex align-items-center gap-2">
                            <i class="bi bi-list-task text-success"></i> รายการ REP ที่พบใน e-Claim (ดาวน์โหลด Excel ช่องสุดท้าย)
                        </div>
...
@push('scripts')
  <script>
        ...
        $(document).ready(function () {
            ...
            var repTable = $('#rep_ucs').DataTable({
                ordering: false,
                dom: '<"row mb-3"' +
                        '<"col-md-6"l>' +
            ...
            $.fn.dataTable.ext.search.push(
                function(settings, data, dataIndex, rowData, counter) {
                    if (settings.sTableId !== 'rep_ucs') return true;
        ...
        $(document).on('click', '.btn-action-delete', function () {
            ...
            Swal.fire({
                ...
                // ==========================================
        // e-Claim REP Automation (ucs)
        // ==========================================
        var repMaininscl = 'ucs';
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.status === 'success') {
                        ...
                        if (res.message && (res.message.includes('หมดอายุ') || res.message.includes('Session'))) {
                            eclaimRepIsConnected = false;
                            checkEclaimRepStatus(true);
                        }
                        $('#botRepTableBody').html(`
                ...
                error: function (xhr) {
                    ...
                    if (xhr.status === 401 || (msg && (msg.includes('หมดอายุ') || msg.includes('Session')))) {
                        eclaimRepIsConnected = false;
                        checkEclaimRepStatus(true);
                    }
                    $('#botRepTableBody').html(`
