    ...
    <div class="page-header-box mt-3 mb-4">
        <div>
            <h5 class="text-dark mb-0 fw-bold">
                ...
                รายละเอียด Statement เบิกจ่ายตรง กทม. BKK [IPD]
            </h5>
            <div class="text-muted small mt-1">รายละเอียดข้อมูลการเบิกจ่ายแยกตามสถานะ ผู้ป่วยใน</div>
            <div class="mt-2">
                <a href="{{ url('import/stm_bkk') }}" class="btn btn-secondary btn-sm rounded-pill px-3">
        ...
        buttons: [
            {
                ...
                action: function ( e, dt, node, config ) {
                    ...
                    window.location.href = "{{ route('stm_bkk_detail_ipd') }}?export=excel&start_date=" + start + "&end_date=" + end;
                }
            }
        ],
        language: {
