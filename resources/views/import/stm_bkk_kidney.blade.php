...
<div class="container-fluid px-lg-4">
    ...
    <div class="row justify-content-center mt-3 mb-4">
        <div class="col-md-8">
            <div class="card dash-card accent-9">
                <div class="card-body">
                    <form id="importForm" onsubmit="simulateProcess(event)" action="{{ url('import/stm_bkk_kidney_save') }}" method="POST" enctype="multipart/form-data" class="m-0">
                        @csrf
                        <div class="text-center mb-3">
                            <h6 class="fw-bold text-dark"><i class="bi bi-file-earmark-excel me-2 text-success"></i> นำเข้าไฟล์ STM BKK (Excel Only)</h6>
    ...
    <div class="page-header-box">
        <div>
            ...
            <div class="mt-2">
                <a href="{{ url('/import/stm_bkk_kidneydetail') }}" class="btn btn-primary btn-sm rounded-pill px-3">
    ...
    <div class="card dash-card border-top-0">
        <div class="card-body p-4">
            <div class="table-responsive">
                <table id="stm_bkk_kidney" class="table table-modern w-100">
                    <thead>
                        <tr>
            ...
            <div class="modal-header border-0 pb-0">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-muted small" id="db_subtitle">ยอดชดเชยสุทธิรายเดือน Statement BKK [ฟอกไต HD]</div>
                    </div>
                </div>
...
@push('scripts')
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.getElementById('btnSaveReceipt')
                .addEventListener('click', function () {
                    ...
                    fetch("{{ url('import/stm_bkk_kidney_updateReceipt') }}", {
                        method: "POST",
                        headers: {
    ...
    <script>
        $(document).ready(function () {
            ...
            var stmTable = $('#stm_bkk_kidney').DataTable({
                ordering: false,
                dom: '<"row mb-3"' +
                        '<"col-md-6"l>' +
                ...
                buttons: [
                {
                    ...
                    title: 'ข้อมูล Statement เบิกจ่ายตรง กทม. BKK [ฟอกไต]'
                }
                ],
                language: {
                    search: "ค้นหา:",
            ...
            $.fn.dataTable.ext.search.push(
                function(settings, data, dataIndex, rowData, counter) {
                    if (settings.sTableId !== 'stm_bkk_kidney') return true;
            ...
            function loadChartData() {
                ...
                $('#db_subtitle').text(`ยอดชดเชยสุทธิรายงวด Statement BKK [ฟอกไต HD] ปีงบประมาณ: ${budgetYearText}`);

                $('#chart_container').addClass('d-none');
                $('#loading_spinner').removeClass('d-none');

                $.ajax({
                    url: "{{ route('import.stm_bkk_kidney.chart-data') }}",
                    method: "GET",
                    data: {
