    ...
    <div class="page-header-box mt-3 mb-4">
        <div>
            <h5 class="text-dark mb-0 fw-bold">
                ...
                รายละเอียด Statement ประกันสุขภาพ ขสมก. (BMT) [ฟอกไต HD]
            </h5>
            <div class="text-muted small mt-1">รายละเอียดข้อมูลการเบิกจ่ายแยกตามสถานะ</div>
            <div class="mt-2">
                <a href="{{ url('import/stm_bmt_kidney') }}" class="btn btn-secondary btn-sm rounded-pill px-3">
    ...
    <div class="card dash-card accent-9 mb-4">
        <div class="card-body p-4">
            <div class="table-responsive">
                <table id="stm_bmt_kidney_list" class="table table-modern w-100">
                    <thead>
                        <tr>
                            <th>REP</th> 
                            <th>HN</th>
...
<script>
    $(document).ready(function () {
      ...
      $('#stm_bmt_kidney_list').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: "{{ route('stm_bmt_kidneydetail') }}",
            data: function (d) {
        ...
        buttons: [
            {
                ...
                action: function ( e, dt, node, config ) {
                    ...
                    window.location.href = "{{ route('stm_bmt_kidneydetail') }}?export=excel&start_date=" + start + "&end_date=" + end;
                }
            }
        ],
        language: {
