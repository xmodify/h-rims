                ...
                <table id="stm_lgo_list" class="table table-modern w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end text-muted">{{ number_format($row->charge_treatment, 2) }}</td>
                            <td class="text-end text-success fw-bold">{{ number_format($row->compensate_treatment, 2) }}</td>
                            <td class="text-end">{{ number_format($row->case_iplg, 2) }}</td> 
                            <td class="text-end">{{ number_format($row->case_oplg, 2) }}</td>
                            <td class="text-end">{{ number_format($row->case_drug, 2) }}</td> 
                        </tr>
                        @endforeach
                    </tbody>
                </table>
