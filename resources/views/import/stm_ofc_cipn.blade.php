...
<div class="container-fluid">
    <div class="row justify-content-center">  
        <div class="col-md-12">             
            ...
            <div class="card-body">
                <form id="importForm" onsubmit="simulateProcess(event)" action="{{ url('import/stm_ofc_cipn_save') }}" method="POST" enctype="multipart/form-data">
                    @csrf      
                    <div class="row mb-2">            
                        <div class="col"></div>
                            <div class="col-md-5">
            ...
            <div class="alert alert-success text-primary" role="alert">
                <strong>ข้อมูล Statement สวัสดิการข้าราชการ CIPN </strong>
            </div>
            
            <div class="card-body">
                <div style="overflow-x:auto;">   
                    <table id="stm_ofc_cipn" class="table table-bordered table-striped my-3">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td align="right" class="text-success">{{ number_format($row->gtotal,2) }}</td>
