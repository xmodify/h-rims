    ...
    <div class="row justify-content-center mt-3 mb-4">
        <div class="col-md-8">
            <div class="card dash-card accent-9">
                <div class="card-body">
                    <form id="importForm" onsubmit="simulateProcess(event)" action="{{ url('import/stm_ofc_kidney_save') }}" method="POST" enctype="multipart/form-data" class="m-0">
                        @csrf
                        <div class="text-center mb-3">
                            <h6 class="fw-bold text-dark"><i class="bi bi-file-earmark-zip me-2 text-primary"></i> นำเข้าไฟล์ STM OFC Kidney (.zip)</h6>
                            <p class="text-muted small">เลือกไฟล์ .zip ที่ได้รับจากระบบ (ฟอกไต)</p>
                        </div>
    ...
    <div class="page-header-box">
        <div>
            <h5 class="text-dark mb-0 fw-bold">
                ...
                ข้อมูล Statement เบิกจ่ายตรงกรมบัญชีกลาง OFC [ฟอกไต]
            </h5>
            <div class="text-muted small mt-1">ปีงบประมาณประจำปัจจุบัน: {{ $budget_year }}</div>
            <div class="mt-2">
                <a href="{{ url('/import/stm_ofc_kidneydetail') }}" class="btn btn-primary btn-sm rounded-pill px-3">
    ...
    <div class="card dash-card border-top-0">
        <div class="card-body p-4">
            <div class="table-responsive">
                <table id="stm_ofc_kidney" class="table table-modern w-100">
                    <thead>
                        <tr>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.getElementById('btnSaveReceipt')
                .addEventListener('click', function () {
                    ...
                    fetch("{{ url('import/stm_ofc_kidney_updateReceipt') }}", {
                        method: "POST",
                        headers: {
