    ...
    <div class="page-header-box mt-3 mb-4">
        <div>
            <h5 class="text-dark mb-0 fw-bold">
                ...
                รายละเอียด Statement สิทธิ์ครูเอกชน PVT [IPD]
            </h5>
        ...
        buttons: [
            {
                ...
                action: function ( e, dt, node, config ) {
                    ...
                    window.location.href = "{{ route('stm_pvt_detail_ipd') }}?export=excel&start_date=" + start + "&end_date=" + end;
                }
            }
        ],
        language: {
