            ...
            <div class="modal-header border-0 pb-0">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-muted small" id="db_subtitle">ยอดชดเชยสุทธิรายเดือน Statement ประกันสังคม SSS [ฟอกไต]</div>
                    </div>
                </div>
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            var stmTable = $('#stm_sss_kidney').DataTable({
            ...
            $.fn.dataTable.ext.search.push(
                function(settings, data, dataIndex, rowData, counter) {
                    if (settings.sTableId !== 'stm_sss_kidney') return true;
            ...
            function loadChartData() {
                ...
                $('#db_subtitle').text(`ยอดชดเชยสุทธิรายงวด Statement ประกันสังคม SSS [ฟอกไต] ปีงบประมาณ: ${budgetYearText}`);

                $('#chart_container').addClass('d-none');
                $('#loading_spinner').removeClass('d-none');

                $.ajax({
                    url: "{{ route('import.stm_sss_kidney.chart-data') }}",
                    method: "GET",
                    data: {
