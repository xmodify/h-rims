                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-body p-3">
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <button type="button" class="btn btn-sm btn-primary rounded-pill px-3 shadow-sm" id="btnEclaimLoginPopup">
...
@push('scripts')
  <script>
        ...
        $(window).on('focus', function () {
            if ($('#eclaimBotModal').hasClass('show')) {
                checkEclaimStatus();
            }
        });
        ...
        $('#btnEclaimLoginPopup').on('click', function () {
            ...
            var checkInterval = setInterval(function () {
                ...
                // Check status via backend every 3 seconds
                if (checkCount % 3 === 0) {
                    $.ajax({
                        url: "{{ route('import.eclaim-bot.status') }}",
                        method: "POST",
