...
<div class="container-fluid px-lg-4">
    ...
    <div class="tab-content col-12 px-0 mt-3" id="monthTabsContent">
        ...
        <div class="tab-pane fade show active" id="content-yearly" role="tabpanel" aria-labelledby="tab-yearly">
            <div class="card shadow-sm border-0" style="border-radius: 12px; border-top: 4px solid #198754 !important; overflow: hidden;">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-3 px-3">
                    <h6 class="mb-0 fw-bold text-success"><i class="bi bi-grid-3x3-gap-fill me-2"></i> รายได้ตามหมวดค่ารักษา IPD ยอดรวมทั้งปี</h6>
                    <button onclick="exportTableToExcel('table-yearly', 'รายได้ IPD หมวดค่ารักษา ยอดรวมทั้งปี')" class="btn btn-success btn-sm rounded-pill px-3 fw-bold" style="font-size: 0.75rem;">
        ...
        <div class="tab-pane fade" id="content-{{ $m }}" role="tabpanel" aria-labelledby="tab-{{ $m }}">
            <div class="card shadow-sm border-0" style="border-radius: 12px; border-top: 4px solid #198754 !important; overflow: hidden;">
                <div class="card-header bg-white d-flex justify-content-between align-items-center py-3 px-3">
                    <h6 class="mb-0 fw-bold text-success"><i class="bi bi-grid-3x3-gap-fill me-2"></i> รายได้ตามหมวดค่ารักษา IPD ประจำเดือน {{ $months_names[$m] }}</h6>
                    <button onclick="exportTableToExcel('table-{{ $m }}', 'รายได้ IPD หมวดค่ารักษา เดือน {{ $months_names[$m] }}')" class="btn btn-success btn-sm rounded-pill px-3 fw-bold" style="font-size: 0.75rem;">
                        <i class="bi bi-file-earmark-excel me-1"></i> Excel
                    </button>
                </div>
                <div class="card-body p-0">
