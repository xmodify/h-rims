    ...
    <div class="page-header-box mt-2 mb-3 d-flex justify-content-between align-items-center">
        ...
        <div>
            ...
            <h4 class="text-primary mb-0 fw-bold">
                ...
                บริการแพทย์แผนไทย นวด,อบ,ประคบ และการดูแลมารดาหลังคลอด
  ...
  $(document).ready(function () {
      ...
      window.initDataTables = function() {
        ...
        dom: '<"row mb-3"' +
                ...
                '<"col-md-6 d-flex justify-content-end align-items-center"f>' + // Search
      ...
      data: {
        ...
        datasets: [

          {
            ...
            label: 'ดูแลมารดาหลังคลอด',

            data: chartData.postpartum_count || [],
...

          {
            ...
            data: chartData.compress_only_count || [],
...

          {
            ...
            data: chartData.massage_only_count || [],
...

          {
            ...
            data: chartData.massage_and_compress_count || [],
...

          {
            ...
            label: 'การใช้ยาจากสมุนไพร',

            data: chartData.herbs_count || [],
        ...
        .done(function(data) {
            ...
            function makeCellHtml(isValid, epDone, warn) {
                if (epDone) {
                    ...
                    return `<button class="btn btn-sm btn-outline-warning px-2 py-1 border-2 d-flex align-items-center justify-content-center" style="font-size:0.7rem; height: 26px; min-height: 26px; margin: 0 auto;" onclick="showDetails('${vn}')" title="ยังไม่ปิดสิทธิ สปสช. | คลิกดูรายละเอียด"><i class="bi bi-eye-fill"></i></button>`;
                }
            }
