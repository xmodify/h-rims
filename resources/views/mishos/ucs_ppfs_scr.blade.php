...
#claim-tab.active {
    ...
    <div class="page-header-box mt-2 mb-3 d-flex justify-content-between align-items-center">
        ...
        <div>
            ...
            <h4 class="text-primary mb-0 fw-bold">
                ...
                รายชื่อผู้รับบริการคัดกรองและประเมินปัจจัยเสี่ยงต่อสุขภาพกาย/สุขภาพจิต (SCR)
    ...
    <x-import_hub_modal 
        ...
        :has-edc="false" 
        :has-fdh="true"
        claim-title="MIS Hospital - รายชื่อผู้รับบริการคัดกรองและประเมินปัจจัยเสี่ยงต่อสุขภาพกาย/สุขภาพจิต (SCR)" 
    />
