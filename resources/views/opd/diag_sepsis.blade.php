  ...
  <div class="row justify-content-center">  
    <div class="col-md-7">
      <div class="card border-info">
        <div class="card-header text-success"><strong>จำนวนผู้ป่วยนอกโรค Sepsis ปีงบประมาณ {{$budget_year}} </strong></div>
        <canvas id="diag_month" style="width: 100%; height: 350px"></canvas>             
      </div>      
    </div>   
    <div class="col-md-5">
      <div class="card border-info">
        <div class="card-header text-success"><strong>จำนวนผู้ป่วยนอกโรค Sepsis 5 ปีงบประมาณย้อนหลัง </strong></div>
...
<div class="container-fluid">   
  <div class="card border-info">
    <div class="card-header bg-success bg-opacity-75 text-white">รายชื่อผู้ป่วยนอกโรค Sepsis ปีงบประมาณ {{$budget_year}} </div>
